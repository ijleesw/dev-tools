...
function! CscopeDBRun(...)
    ...
    let tb_src_home = g:prj_cur_home."/src"
    let cs_opt = a:1
    let cs_msg = a:2
    let cs_pattern = a:3

    let cmd = "cscope -d -P".tb_src_home." -f".tb_src_home."/cscope.out -i".tb_src_home."/cscope.files -L -".cs_opt." ".cs_pattern." | awk '{print $1,$3,$2}'"
